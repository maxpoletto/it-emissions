...
121 & \cite{ecoinvent}  \\ \hline
104 & \cite{teehan2013} (low) \\ \hline
338 & \cite{teehan2013} (high) \\ \hline
244 & \cite{rarecoil} \\ \hline
202 & \cite{unctadder2024} \\ \hline
\end{tabular}
\label{tab:embodied_emissions:laptops}
\end{center}

The Ecoinvent numbers appear to be outliers on the low end.
The most comprehensive data comes from \cite{rarecoil}, which lists manufacturer
...
\textbf{Production \& Disposal} & \\
\textbf{(kg CO$_2$e)} & \textbf{Source} \\ \hline
238 & \cite{ecoinvent} \\ \hline
303 & \cite{teehan2013} \\ \hline
403 & \cite{unctadder2024} \\ \hline
289 & \cite{dellpcf} \\ \hline
277 & \cite{boavizta} \\ \hline
\end{tabular}
...
\textbf{Production \& Disposal} & \\
\textbf{(kg CO$_2$e)} & \textbf{Source} \\ \hline
383 & \cite{teehan2013} \\ \hline
1252 & \cite{davy2021} (Dell) \\ \hline
1912 & \cite{davy2021} (EC2) \\ \hline
899 & \cite{boavizta} (medium server)\\ \hline
\end{tabular}
\label{tab:embodied_emissions:servers}
\end{center}

\cite{davy2021} reports data for many Dell servers and estimates for different types of EC2 instances.
...
\textbf{Production \& Disposal} & \\
\textbf{(kg CO$_2$e)} & \textbf{Source} \\ \hline
68 & \cite{googlepixel8} (Pixel 8)\\ \hline
54 & \cite{appleiphone13} (iPhone 13)\\ \hline
50 & \cite{unctadder2024} \\ \hline
50 & \cite{lovehagen2023} \\ \hline
\end{tabular}
...
\begin{description}
    \item[Computer monitors] 344 kg CO$_2$e (\cite{teehan2013}, \cite{dellpcf})
    \item[Conference room displays] 753 kg CO$_2$e (scaling monitor by $(40''/27'')^2$)
    \item[Printer/copier stations] 1167 kg CO$_2$e (\cite{ecoinvent})
...
However, \cite{devries2023growing} provides the following information about ChatGPT:
\begin{itemize}
...
However, for the purposes of the model, we use data from \cite{electricitymaps}. Specifically,
